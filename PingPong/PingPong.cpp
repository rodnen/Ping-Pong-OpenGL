...
// PingPong.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPingPongApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CPingPongApp::OnAppAbout)
...
// Создание CPingPongApp

CPingPongApp::CPingPongApp() noexcept
{
	...
	SetAppID(_T("PingPong.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CPingPongApp

CPingPongApp theApp;


// Инициализация CPingPongApp

BOOL CPingPongApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CPingPongDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CPingPongView));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений CPingPongApp
...
void CPingPongApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Методы загрузки или сохранения настроек CPingPongApp

void CPingPongApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CPingPongApp::LoadCustomState()
{
}

void CPingPongApp::SaveCustomState()
{
}
